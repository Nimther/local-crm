...
// Uncovered STATEMENTS in an already-loaded module. The first attempt used
// one-line if/else pairs and v8 counted only 27 of them — the denominator went
// 4264 -> 4291 and the gate stayed green at 0.81426. It needs to exceed 4299,
// so each statement now sits on its own line.
