...
### 4.2 Доменные таблицы (23 из 25 — с RLS ENABLE + FORCE; исключения — `partition_maintenance_runs` и `send_reconciler_runs` (`0050`, Phase 11), см. конец раздела)
