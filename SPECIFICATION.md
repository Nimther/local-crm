...
- Журнал: `migrations/meta/_journal.json`, version 7, 40 записей (0–39). Snapshot'ы есть только у **11** миграций (`0000`, `0002`, `0003`, `0005`, `0008`, `0011`, `0016`, `0017`, `0024`, `0025`, `0034`); у остальных **29** (включая `0038`, `0039`) — нет.
