...
1. **Exact PITR target for the D-08 in-phase restore drill**
...
2. **Whether the negative-fixture tests under `scripts/__fixtures__/prod-compose/*.yml` using `image: megacrm-postgres:local` need updating**
